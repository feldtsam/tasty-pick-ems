...
cfb/scoring.py. Copied VERBATIM from nfl/normalize.py (itself copied from
backtest/scoring/normalize.py) — each top-level domain is self-contained
by design; the "duplicate rather than cross-import" rule stated throughout
this codebase. The three functions below are byte-identical to the NFL
copy so the percentile math has identical semantics.
