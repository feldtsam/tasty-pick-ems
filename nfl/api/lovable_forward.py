...
COPIED from pipeline/api/lovable_forward.py, not imported — see
nfl/api/index.py's module docstring for why this NFL deployment doesn't
depend on pipeline/'s codebase. Logic is identical; only this comment
block and the module docstring differ.
